...
class Provider(models.Model):
    ...
    base_tariff = models.ForeignKey(BaseTariff, blank=True, null=True, on_delete=models.DO_NOTHING)
    bundles = models.ForeignKey(Bundles, blank=True, null=True)
    destination_group = models.ForeignKey(DestinationGroup, blank=True, null=True, on_delete=models.DO_NOTHING)
